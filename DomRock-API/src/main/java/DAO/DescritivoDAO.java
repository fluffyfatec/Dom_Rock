...
public class DescritivoDAO {
	...
	ConsultaIdDTO idCliente;

	public void cadastrarDescritivo(ClienteDTO objClienteDTO) {
		String sql = "INSERT INTO Descritivo (objetivo_negocio," + "entregavel_min,"
				+ "entregavel_possivel, id_cliente)" + "values (?,?,?," + idCliente.getSqlIdCliente() + ")";
