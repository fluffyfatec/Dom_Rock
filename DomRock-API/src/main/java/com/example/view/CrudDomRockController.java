...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void btn_consulta_deletar() {
    	if (table_cliente.getSelectionModel().getSelectedItem()== null) {
    		...
    		if (exibiDialogoConfirmação("Confirmar a exclusão do cliente selecionado?")) {
    	  
    			try{
					dao.deletar(table_cliente.getSelectionModel().getSelectedItem().getId_cliente());;
					exibiDialogoConfirmação("Cliente deletado com sucesso.");
					btn_consulta_cnpj();
    				}catch (Exception e) {
    ...
    private void exibiDialogoINFO(String informacao) {
     ...
     private boolean exibiDialogoConfirmação(String confirmação) {
     	Alert alert = new Alert(AlertType.CONFIRMATION);
     	alert.setTitle("Confirmação");
     	alert.setHeaderText(null);
     	alert.setContentText(confirmação);
