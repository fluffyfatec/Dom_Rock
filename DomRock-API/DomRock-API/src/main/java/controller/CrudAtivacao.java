...
public class CrudAtivacao implements Initializable {
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		// Populando o Core 
		ObservableList<String> listcore = FXCollections.observableArrayList("Web App", "API", "Gateway", "Filas", "Step Function", "Lambda", "Fargate", "Containers", "S3", "Mongodb", "Parquet","Quicksight","Cloudwatch");
		...
		ObservableList<String> listfuncionalidades = FXCollections.observableArrayList("Painéis por soluções", "Busca (NLP)", "Gerador de Relatório", "Gerador de Data Lake");
