...
public class EscopoDTO {
	...
	public String getObjNegocios() {
		return objNegocios;
	}
	public void setObjNegocios(String objNegocios) {
		this.objNegocios = objNegocios;
	}
	...
	public void setMatchingRisk(String matchingRisk) {
		this.matchingRisk = matchingRisk;
	}
