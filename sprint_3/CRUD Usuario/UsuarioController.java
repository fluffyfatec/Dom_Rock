...
import modal.CadastroUsuarioDAO;
import modal.CadastroUsuarioDTO;
...
public class UsuarioController implements Initializable {
    ...
    @FXML
    private TableView<CadastroUsuarioDTO> tabelaUsuario;

    @FXML
    private TableColumn<CadastroUsuarioDTO, Integer> colUsuarioId;
    
    @FXML
    private TableColumn<CadastroUsuarioDTO, String> colUsuarioFuncao;

    @FXML
    private TableColumn<CadastroUsuarioDTO, String> colUsuarioNome;

    @FXML
    private TableColumn<CadastroUsuarioDTO, String> colUsuarioUsuario;
    
    @FXML
    private TableColumn<CadastroUsuarioDTO, String> colUsuarioSenha;
    ...
    private CadastroUsuarioDTO usuarioSelecionado;
    ...
    void btnUsuarioConsultar() {
    	try {
    		List<CadastroUsuarioDTO> resultado =  dao.consultar(txtUsuarioConsultar.getText());
