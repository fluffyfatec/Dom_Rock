...
public class CadastroUsuarioDAO {
	...
	public void cadastrarUsuario(CadastroUsuarioDTO objusuarioDTO){
	...
	public void atualizar(CadastroUsuarioDTO cadastroUsuarioDTO) {
	...
	public List<CadastroUsuarioDTO> consultar(String usuario) {
			
		List<CadastroUsuarioDTO> usuarios = new ArrayList<>();
